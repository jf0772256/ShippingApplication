...
namespace shipapp
{
    ...
    public partial class Receiving : Form
    {
        ...
        {
            //
            Package packageToBeRemoved = DataConnectionClass.DataLists.Packages.FirstOrDefault(pid => pid.PackageId == Convert.ToInt64(dataGridPackages.SelectedRows[0].Cells[0]));
